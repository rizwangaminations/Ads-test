...
bool RenderState::_isInitialised = false;
...
void RenderState::initialize(bool firstInit)
{
    if (StateBlock::_defaultState == nullptr)
    {
        StateBlock::_defaultState = StateBlock::create(firstInit);
        CC_SAFE_RETAIN(StateBlock::_defaultState);
        if (StateBlock::_defaultState)
        {
            RenderState::_isInitialised = true;
        }
    }
}
...
// StateBlock
//
RenderState::StateBlock* RenderState::StateBlock::create(bool firstInit)
{
    ...
    {
        assert(false && "Not enough memory for initializing StateBlock::_defaultState");
    }
