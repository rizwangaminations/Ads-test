...
public:
    ...
    void setMask(cocos2d::Node* value, bool inverted = false, bool swallowTouches = true);
    bool isMaskSwallowTouches();
    void setMaskSwallowTouches(bool swallowTouches);
