...
{
public:
    GRoot(cocos2d::Node* container);
    virtual ~GRoot();

    static GRoot* create(cocos2d::Node* node, int zOrder = 1000);
...
private:
    bool initWithNode(cocos2d::Node* node, int zOrder);
    ...
    static std::unordered_map<cocos2d::Node*, GRoot*> _instanceMap;
